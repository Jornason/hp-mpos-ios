//
//  hpListOfRecordsViewController.h
//  mPOS-withSlideView
//
/*
...
#import "hpListOfRecordsCell.h"
#import "hpReceiptViewController.h"

@class hpReceipt;

@interface hpListOfRecordsViewController : UITableViewController <UITableViewDelegate, UITableViewDataSource>
{
...
@property (retain, nonatomic) NSDictionary* currencySymbol;
