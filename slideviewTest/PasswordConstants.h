...
// Constants for textfields
#define FIRST_PASSCODE_TEXTFIELD ((NSInteger)1)
#define LAST_PASSCODE_TEXTFIELD ((NSInteger)4)
#define FIRST_CREATE_PASSCODE_TEXTFIELD ((NSInteger)5)
#define LAST_CREATE_PASSCODE_TEXTFIELD ((NSInteger)8)
#define FIRST_VERIFY_PASSCODE_TEXTFIELD ((NSInteger)9)
#define LAST_VERIFY_PASSCODE_TEXTFIELD ((NSInteger)12)
